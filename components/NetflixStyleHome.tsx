...
import { Gamepad2, AlertTriangle, ExternalLink } from "lucide-react";
...
export default function NetflixStyleHome() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* Header with search */}
      <div className="sticky top-16 z-30 bg-gray-900/95 backdrop-blur-sm border-b border-gray-800 py-6">
